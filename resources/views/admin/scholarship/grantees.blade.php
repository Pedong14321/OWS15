...
<head>
    ...
    <link rel="stylesheet"
          href="https://fonts.googleapis.com/css2?family=Font1:style1,style2|Font2:style1,style2&display=swap">
    ...
    <style>
        ...
        .fixed-button {
            position: fixed;
            top: 28%;
            right: 5.7rem; /* Adjust the value as needed */
            transform: translateY(-50%);
            z-index: 1; /* Adjust the z-index to layer it appropriately */
        }
        ...
        .fixed-header {
            position: sticky;
            top: 0;
            color: white; /* Set your header text color */
                        ...
                        <td class="w-4 p-4">
                            <div class="flex items-center">
                                <input id="checkbox-table-search-2" type="checkbox"
                                       class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-500 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                <label for="checkbox-table-search-2" class="sr-only">checkbox</label>
                            </div>
                        </td>
                        <th scope="row"
                            class="flex items-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            <img class="w-10 h-10 rounded-full" src="/images/cristine.jpg"
                                 alt="${lastName.value} image">
                            <div class="pl-3">
...
<div class="sm:ml-64">
    ...
    <div class="p-4 m-4 shadow-lg bg-white border-gray-200 rounded-lg dark:border-gray-700 " style="overflow-x: auto;">
        ...
        <br>
        {{--table div--}}
        <div class="relative overflow-x-auto overflow-y-auto shadow-md sm:rounded-lg border-2"
             style="height: 68vh;">
            <div class="tablet-stack fixed-button flex pb-4 items-end justify-between">
                ...
                <div class="relative">
                    ...
                    <input type="text" id="table-search-users"
                           class="block p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg h-9 w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                           placeholder="Search for users">
                </div>
                <div class="absolute top-0 right-0 flex items-center justify-center">
                    <button type="button" id="addBtn" onclick="filter()"
                            class="px-3 text-base font-medium h-9 w-fit text-white rounded-lg border focus:ring-4 focus:outline-none"
            ...
            <form method="POST" action="scholarships-grantees">
                ...
                <div class="fixed-add-button flex pb-4 items-end justify-end">
                    <div class="absolute top-0 right-0 flex items-center justify-center">
                        <button type="button" id="addBtn" onclick="addGrantee()"
                        class="px-3 text-base font-medium h-9 w-fit text-white rounded-lg border focus:ring-4 focus:outline-none"
                        style="border-color: #630606; background-color: #630606">
            ...
            <table id="table-container" class="grantees-table table w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <th scope="col" class="p-4">
                        <div class="flex items-center">
                            <input id="checkbox-all-search" type="checkbox"
                                   class="w-4 h-4 text-blue-600 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2"
                                   style="background-color: #630606; border: 1px solid white">
                ...
                <tr id="table-row" class="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-600">
                    <td class="w-4 p-4">
                        <div class="flex items-center">
                    ...
                    <th scope="row"
                        class="flex items-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                        <img class="w-10 h-10 rounded-full" src="/images/sydney.jpg"
                             alt="Jese image">
                        <div class="pl-3">
    ...
    <div class="Filtermodal relative p-5 bg-white   rounded-3xl h-auto " >
        ...
        <div class="flex justify-end space-x-2">
            ...
            <button onclick="closeModal()"
                    class="btn-del p-1.5 rounded-2xl w-1/2">Cancel</button>
            <button onclick="applyFilter()"
                    class="btn p-1.5 rounded-2xl w-1/2"
                    style="background-color: #630606; color: white"> Apply Filter</button>
        </div>
    </div>
</div>
<script>
...
{{--visibility--}}
<div data-aos="flip-up" id="visibilityModal"
     class="fixed inset-0 z-50 hidden overflow-auto bg-black bg-opacity-50 flex items-center justify-center rounded-lg">
    {{--white div--}}
    ...
    <div class="relative flex flex-col items-center justify-center w-auto rounded-3xl">
        ...
        <div class="relative flex items-center justify-center w-auto rounded-3xl" style="background-color: #630606">
            ...
            <div class="relative p-8 bg-white max-w-2xl mt-4 rounded-3xl text-center">
                {{--    delete icon--}}
                <div class="flex justify-center items-center h-20 w-20 rounded-full"
                     style="margin-top: -70px; margin-left: 40%; background-color: #630606;">
                ...
                <div class="sm:px-16">
                    ...
                    <input type="password" id="passwordConfirmation"
                           class="border p-2 mb-4 w-full items-center text-center rounded-lg"
                           placeholder="Enter your password">

                    <div class="flex justify-end space-x-2">
                        <button onclick="cancelDelete()" class="btn-del p-1.5 rounded-2xl w-1/2">Cancel</button>
                        <button id="deleteButton" onclick="confirmDelete()" class="btn p-1.5 rounded-2xl w-1/2"
                                style="background-color: #630606; color: white">
                            Delete
                        </button>
                    </div>
...
<div id="confirmation-modal"
    ...
    <div class="modal-box p-8 bg-white shadow-lg rounded-lg">
        ...
        <div class="flex justify-end">
            ...
            <button onclick="closeConfirmationModal()" class="btn btn-primary ml-2 p-1.5 rounded-2xl w-1/2"
...
<div id="confirmation-modal-for-creation"
     class="fixed inset-0 z-50 hidden overflow-auto bg-black bg-opacity-50 flex items-center justify-center rounded-lg">
    <div class="modal-box p-8 bg-white shadow-lg rounded-lg">
